...
namespace ds::amt {
	...
	public:
		...
		class InOrderHierarchyIterator : public Hierarchy<BlockType>::DepthFirstIterator
		{
		public:
	...
	size_t Hierarchy<BlockType>::nodeCount() const
	{
		...
		this->processPreOrder(this->accessRoot(), [&](const BlockType* b)
			{
				result++;
			});
	...
	size_t Hierarchy<BlockType>::nodeCount(const BlockType& node) const
	{
		...
		this->processPreOrder(&node, [&](const BlockType* b)
			{
				result++;
			});
	...
	void Hierarchy<BlockType>::processPreOrder(const BlockType* node, std::function<void(const BlockType*)> operation) const
	{
		if (node)
		{
			...
			size_t maxDeg = this->degree(*node);
			size_t sonsProcessed = 0;

			for (size_t sonOrder = 0; sonsProcessed < maxDeg; sonOrder++)
			{
	...
	template<typename BlockType>
	Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(Hierarchy<BlockType>* hierarchy) : hierarchy_(hierarchy), currentPosition_(nullptr) {}

	template<typename BlockType>
	Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(const DepthFirstIterator& other) : DepthFirstIterator(other.hierarchy_)
	{
		DepthFirstIteratorPosition* myPosition = nullptr;

		for (DepthFirstIteratorPosition* otherPosition = other.currentPosition_; otherPosition; otherPosition = otherPosition->previousPosition_)
		{
	...
	template<typename BlockType>
	Hierarchy<BlockType>::PreOrderHierarchyIterator::PreOrderHierarchyIterator(Hierarchy<BlockType>* hierarchy, BlockType* node) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(hierarchy)
	{
		if (node != nullptr)
		{
	...
	template<typename BlockType>
	Hierarchy<BlockType>::PreOrderHierarchyIterator::PreOrderHierarchyIterator(const PreOrderHierarchyIterator& other) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(other) {}
	...
	template<typename BlockType>
	Hierarchy<BlockType>::PostOrderHierarchyIterator::PostOrderHierarchyIterator(Hierarchy<BlockType>* hierarchy, BlockType* node) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(hierarchy)
	{
		if (node != nullptr)
		{
			this->savePosition(node);
	...
	template<typename BlockType>
	Hierarchy<BlockType>::PostOrderHierarchyIterator::PostOrderHierarchyIterator(const PreOrderHierarchyIterator& other) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(other) {}
	...
	template<typename BlockType>
	BinaryHierarchy<BlockType>::InOrderHierarchyIterator::InOrderHierarchyIterator(BinaryHierarchy<BlockType>* hierarchy, BlockType* node) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(hierarchy)
	{
		if (node != nullptr)
		{
			this->savePosition(node);
	...
	template<typename BlockType>
	BinaryHierarchy<BlockType>::InOrderHierarchyIterator::InOrderHierarchyIterator(const InOrderHierarchyIterator& other) : Hierarchy<BlockType>::DepthFirstIterator::DepthFirstIterator(other) {}
