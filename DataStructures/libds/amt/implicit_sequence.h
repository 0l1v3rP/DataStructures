...
namespace ds::amt
{
	...
	public:
		...
		public:
			...
			ImplicitSequenceIterator operator+(int);
			ImplicitSequenceIterator operator<(ImplicitSequenceIterator);
	...
	template<typename DataType>
	auto ImplicitSequence<DataType>::ImplicitSequenceIterator::operator+(int value) -> ImplicitSequenceIterator
	{
		position_ += value;
		return *this;
	}
