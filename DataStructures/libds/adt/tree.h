...
namespace ds::adt {
    ...
    class GeneralTree : virtual public Tree<T>, public ADS<T>
    {
    public:
    ...
    template <typename T, typename HierarchyType>
    GeneralTree<T, HierarchyType>::GeneralTree() : ADS<T>(new HierarchyType()) {}

    template <typename T, typename HierarchyType>
    GeneralTree<T, HierarchyType>::GeneralTree(const GeneralTree& other) : ADS<T>(new HierarchyType(), other) {}
